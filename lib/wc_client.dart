...
typedef SocketClose = void Function(int? code, String? reason, WCSession? sessionData);
    ...
    _socketStream.listen(
      ...
      onDone: () {
        if (_isConnected) {
          ...
          onDisconnect?.call(_webSocket.closeCode, _webSocket.closeReason, _session);
          _resetState();
        }
      },
    );
